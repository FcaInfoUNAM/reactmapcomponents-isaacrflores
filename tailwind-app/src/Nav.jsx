...
// Mapeamos el array 'navigation' para generar elementos de lista dinámicos:
//     - 'map' itera sobre cada elemento (e) del array
//     - Por cada elemento, retornamos un <li> con un enlace
//     - 'e' contiene las propiedades de cada ítem de navegación: